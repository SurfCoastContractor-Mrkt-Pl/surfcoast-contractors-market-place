          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            {!isContractor && (
              <Link to={createPageUrl('PostJob')} style={{ textDecoration: "none", display: "inline-block" }}>
                <button style={{ display: "flex", alignItems: "center", gap: 6, padding: "9px 18px", borderRadius: 6, background: T.amberBg, border: `1px solid #D9B88A`, color: T.amber, fontWeight: 700, fontSize: 13, ...mono, cursor: "pointer" }}>
