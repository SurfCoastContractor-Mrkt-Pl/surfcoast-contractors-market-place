    ...
    <div style={{ position:"fixed", inset:0, overflowY:"auto", overflowX:"hidden", display:"flex", flexDirection:"column", fontFamily:"'Inter','Segoe UI',sans-serif", background:"#0a1628" }}>
      ...
      <header style={{ position:"sticky", top:0, zIndex:10, display:"flex", alignItems:"center", justifyContent:"space-between", padding:"10px 16px", background:"rgba(10,22,40,0.5)", backdropFilter:"blur(12px)", borderBottom:"1px solid rgba(255,255,255,0.08)", minHeight:"44px" }}>
         ...
         <nav style={{ display:"flex", gap:"8px", alignItems:"center", position:"relative" }}>
            <button onMouseEnter={(e) => e.target.style.boxShadow = "0 0 12px rgba(37,137,199,0.6)"} onMouseLeave={(e) => e.target.style.boxShadow = "none"} onClick={() => setDropdownOpen(!dropdownOpen)} style={{ color:"#fff", textDecoration:"none", fontSize:"12px", fontWeight:"700", padding:"6px 14px", background:"#1d6fa4", borderRadius:"20px", border:"1px solid #2589c7", whiteSpace:"nowrap", height:"32px", display:"flex", alignItems:"center", cursor:"pointer", gap:"6px", transition:"all 0.2s" }}>
      ...
      <main style={{ position:"relative", zIndex:2, display:"flex", flexDirection:"column", alignItems:"center", padding:isMobile ? "clamp(16px, 3vw, 24px) 12px 8px" : "28px 16px 8px", width:"100%", flex:1 }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:isMobile ? "1fr" : "repeat(3, 1fr)", alignItems:"stretch", width:"100%", maxWidth:"900px", gap:isMobile ? "clamp(12px, 3vw, 16px)" : "clamp(12px, 2vw, 16px)", justifyContent:"center", marginBottom:"24px" }}>
          ...
          >
            ...
            <button onMouseEnter={(e) => e.target.style.boxShadow = "0 0 12px rgba(157,122,84,0.6), 0 4px 8px rgba(157,122,84,0.3)"} onMouseLeave={(e) => e.target.style.boxShadow = "none"} onClick={() => window.location.href = '/MarketShopSignup?type=farmers_market'} style={{ width:"100%", padding:"10px 14px", borderRadius:"8px", border:"none", fontSize:"13px", fontWeight:"700", cursor:"pointer", transition:"all 0.2s", minHeight:"40px", background:"#9d7a54", color:"#fff" }}>Get Started →</button>
          </div>
          ...
          >
            ...
            <button onMouseEnter={(e) => e.target.style.boxShadow = "0 0 12px rgba(249,115,22,0.6), 0 4px 8px rgba(249,115,22,0.3)"} onMouseLeave={(e) => e.target.style.boxShadow = "none"} onClick={() => window.location.href = '/MarketShopSignup?type=swap_meet'} style={{ width:"100%", padding:"10px 14px", borderRadius:"8px", border:"none", fontSize:"13px", fontWeight:"700", cursor:"pointer", transition:"all 0.2s", minHeight:"40px", background:"#f97316", color:"#fff" }}>Get Started →</button>
          </div>
