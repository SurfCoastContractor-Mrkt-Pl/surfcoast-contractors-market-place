      ...
      <section className="relative overflow-hidden py-16 lg:py-28 px-4 lg:px-8" style={{backgroundColor: '#007BA7'}}>
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="relative h-[400px] flex items-center justify-center">
            ...
            <div className="absolute top-0 left-[18%] -translate-x-1/2 w-40 h-40 rounded-full border-2 flex items-center justify-center transition-all group cursor-pointer z-40" style={{backgroundColor: 'rgba(255, 248, 0, 0.3)', borderColor: 'rgba(255, 248, 0, 0.5)'}} onMouseEnter={(e) => e.currentTarget.style.boxShadow = '0 0 40px rgba(255, 191, 0, 0.8)'} onMouseLeave={(e) => e.currentTarget.style.boxShadow = 'none'}>
            ...
            <div className="absolute top-0 left-[40%] -translate-x-1/2 w-40 h-40 rounded-full border-2 flex items-center justify-center transition-all group cursor-pointer z-30" style={{backgroundColor: 'rgba(255, 248, 0, 0.3)', borderColor: 'rgba(255, 248, 0, 0.5)'}} onMouseEnter={(e) => e.currentTarget.style.boxShadow = '0 0 40px rgba(255, 191, 0, 0.8)'} onMouseLeave={(e) => e.currentTarget.style.boxShadow = 'none'}>
            ...
            <div className="absolute top-0 left-[60%] -translate-x-1/2 w-40 h-40 rounded-full border-2 flex items-center justify-center transition-all group cursor-pointer z-20" style={{backgroundColor: 'rgba(255, 248, 0, 0.3)', borderColor: 'rgba(255, 248, 0, 0.5)'}} onMouseEnter={(e) => e.currentTarget.style.boxShadow = '0 0 40px rgba(255, 191, 0, 0.8)'} onMouseLeave={(e) => e.currentTarget.style.boxShadow = 'none'}>
            ...
            {/* Circle 4: WAVE OS */}
            <div className="absolute top-0 left-[82%] -translate-x-1/2 w-40 h-40 rounded-full border-2 flex items-center justify-center transition-all group cursor-pointer z-10" style={{backgroundColor: 'rgba(255, 248, 0, 0.3)', borderColor: 'rgba(255, 248, 0, 0.5)'}} onMouseEnter={(e) => e.currentTarget.style.boxShadow = '0 0 40px rgba(255, 191, 0, 0.8)'} onMouseLeave={(e) => e.currentTarget.style.boxShadow = 'none'}>
            ...
            <div className="absolute bottom-16 left-[29%] -translate-x-1/2 w-28 h-28 rounded-full border-2 flex items-center justify-center transition-all group cursor-pointer z-40" style={{backgroundColor: 'rgba(255, 248, 0, 0.3)', borderColor: 'rgba(255, 248, 0, 0.5)'}} onMouseEnter={(e) => e.currentTarget.style.boxShadow = '0 0 30px rgba(255, 191, 0, 0.8)'} onMouseLeave={(e) => e.currentTarget.style.boxShadow = 'none'}>
            ...
            <div className="absolute bottom-16 left-[50%] -translate-x-1/2 w-28 h-28 rounded-full border-2 flex items-center justify-center transition-all group cursor-pointer z-30" style={{backgroundColor: 'rgba(255, 248, 0, 0.3)', borderColor: 'rgba(255, 248, 0, 0.5)'}} onMouseEnter={(e) => e.currentTarget.style.boxShadow = '0 0 30px rgba(255, 191, 0, 0.8)'} onMouseLeave={(e) => e.currentTarget.style.boxShadow = 'none'}>
            ...
            <div className="absolute bottom-16 left-[71%] -translate-x-1/2 w-28 h-28 rounded-full border-2 flex items-center justify-center transition-all group cursor-pointer z-20" style={{backgroundColor: 'rgba(255, 248, 0, 0.3)', borderColor: 'rgba(255, 248, 0, 0.5)'}} onMouseEnter={(e) => e.currentTarget.style.boxShadow = '0 0 30px rgba(255, 191, 0, 0.8)'} onMouseLeave={(e) => e.currentTarget.style.boxShadow = 'none'}>
