...
export default function Home() {
  ...
  return (
    <div style={{ position:"relative", display:"flex", flexDirection:"column", fontFamily:"'Inter','Segoe UI',sans-serif", overflow:"hidden", background:"#0a1628", minHeight:"100vh", width:"100vw" }}>
      ...
      <main style={{ position:"relative", zIndex:2, display:"flex", flexDirection:"column", alignItems:"center", padding:isMobile ? "clamp(16px, 3vw, 24px) 12px clamp(12px, 4vw, 20px)" : "28px 16px 20px", overflowY:"auto", width:"100%" }}>
