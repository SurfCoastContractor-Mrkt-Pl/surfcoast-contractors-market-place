      ...
      <section className="relative overflow-hidden bg-background py-16 lg:py-28 px-4 lg:px-8">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="relative h-[400px] flex items-center justify-center">
            ...
            <div className="absolute top-0 left-[18%] -translate-x-1/2 w-40 h-40 rounded-full bg-gray-300 border-2 border-gray-400 flex items-center justify-center hover:shadow-2xl transition-all group cursor-pointer z-40">
            ...
            <div className="absolute top-0 left-[40%] -translate-x-1/2 w-40 h-40 rounded-full bg-gray-300 border-2 border-gray-400 flex items-center justify-center hover:shadow-2xl transition-all group cursor-pointer z-30">
            ...
            <div className="absolute top-0 left-[60%] -translate-x-1/2 w-40 h-40 rounded-full bg-gray-300 border-2 border-gray-400 flex items-center justify-center hover:shadow-2xl transition-all group cursor-pointer z-20">
            ...
            {/* Circle 4: WAVE OS */}
            <div className="absolute top-0 left-[82%] -translate-x-1/2 w-40 h-40 rounded-full bg-gray-300 border-2 border-gray-400 flex items-center justify-center hover:shadow-2xl transition-all group cursor-pointer z-10">
            ...
            <div className="absolute bottom-16 left-[29%] -translate-x-1/2 w-28 h-28 rounded-full bg-gray-300 border-2 border-gray-400 flex items-center justify-center hover:shadow-lg transition-all group cursor-pointer z-40">
            ...
            <div className="absolute bottom-16 left-[50%] -translate-x-1/2 w-28 h-28 rounded-full bg-gray-300 border-2 border-gray-400 flex items-center justify-center hover:shadow-lg transition-all group cursor-pointer z-30">
            ...
            <div className="absolute bottom-16 left-[71%] -translate-x-1/2 w-28 h-28 rounded-full bg-gray-300 border-2 border-gray-400 flex items-center justify-center hover:shadow-lg transition-all group cursor-pointer z-20">
