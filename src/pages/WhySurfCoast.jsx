...
const STAND_APART = [
  ...
  { title: "Platform independence — legally clear", body: "SurfCoast Contractors Marketplace is a neutral technology platform. Its role is strictly limited to providing tools that help independent entrepreneurs and clients find each other, communicate, manage projects, and process payments through a secure system. SurfCoast does not employ, supervise, direct, or control the manner or means by which any entrepreneur performs their work. SurfCoast does not guarantee the quality, safety, legality, or timeliness of any services arranged through the platform. Each entrepreneur is solely responsible for their own licensing, permits, agreements, insurance, and any required verifications in their jurisdiction. The actual service relationship exists exclusively between the entrepreneur and the client — not between either party and SurfCoast." },
];
