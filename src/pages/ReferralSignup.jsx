          ...
          <div style={{
            ...
            {sendSuccess ? (
              <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ fontSize: '14px', color: '#666', margin: 0 }}>
                  Your referral link has been sent to {recipientEmail}
                </p>
              </div>
            ) : (
              <>
                ...
                <p style={{ fontSize: '13px', color: '#666', marginBottom: '16px', margin: 0 }}>
                ...
                <div style={{ display: 'flex', gap: '12px' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: '8px',
                      border: 'none',
                      background: sendingEmail || !recipientEmail.trim() ? '#ccc' : '#10b981',
                      color: '#fff',
                      fontSize: '14px',
                      fontWeight: '600',
