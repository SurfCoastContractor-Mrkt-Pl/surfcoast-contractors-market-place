...
const FAQ_ITEMS = [
  ...
  { q: "Is messaging free?", a: "No. Communication is not free — profile and listing are free. Sessions are available for $1.50 per 10 minutes each, or you can add the $50/month Unlimited Communication plan. WAVE OS Max and Premium subscribers get free messaging with past clients (people they have already completed a job with)." },
          ...
          <div style={{ ...cardStyle, padding: "32px 28px", display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <div style={{ background: T.amberTint, border: `0.5px solid #D9B88A`, borderRadius: 8, padding: 16 }}>
                ...
                <p style={{ ...mono, fontSize: 18, fontWeight: 700, color: T.dark, margin: "0 0 3px" }}>$50<span style={{ fontSize: 12 }}>/month</span></p>
                <p style={{ fontSize: 11, color: T.muted, margin: 0, fontStyle: "italic" }}>Unlimited messaging. WAVE OS Max & Premium get free messaging with past clients.</p>
              </div>
              <div style={{ background: T.bg, border: `0.5px solid ${T.border}`, borderRadius: 8, padding: 16 }}>
