...
const FAQ_ITEMS = [
  { q: "How much does SurfCoast Contractors Marketplace cost?", a: "SurfCoast Contractors Marketplace has a transparent performance-based pricing model. For all workers: Profile creation and listing are free forever. An 18% Project Completion Fee applies only when a job is completed and paid through the platform. Communication sessions cost $1.50 per 10 minutes or $50 per month for unlimited messaging. Receiving and responding to a client's proposal request is always free for the worker. WAVE OS Max ($59/month) and Premium ($100/month) subscribers get free messaging with past clients only. For clients: Browsing worker profiles is free. Sending a Request for Proposal to a specific worker costs $1.75 per proposal request. Communication sessions cost $1.50 per 10 minutes or $50 per month for unlimited messaging. For WAVE OS subscribers: Starter $19 per month becomes available at 5 completed jobs. Pro $39 per month and Max $59 per month become available progressively. Premium $100 per month becomes available at 100 completed jobs and requires a verified professional license as a licensed Sole Proprietor. For Market Shop vendors: $20 per month flat fee which waives the 5% facilitation fee entirely, or 5% per sale with no monthly fee. WAVEshop OS is $35 per month for advanced inventory, analytics, and market hub tools. For everyone: The first 100 signups receive one full year of free access. After the Founding 100 spots are taken, new signups receive a free 14-day trial." },
