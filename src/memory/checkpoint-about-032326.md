# About Page Checkpoint — 2026-03-23

## Summary of Changes
Full redesign of `pages/About.jsx` across two sessions:
1. Text contrast overhaul — moved from matching sunset gradient colors to high-contrast white (top) → navy (mid) → near-black (bottom).
2. Founder section complete redesign — replaced inline gradient-text section with a full-width dark navy panel (`#0d1b2a`) that visually breaks from the sunset, with orange (`#F97316`) accent elements.

---

## Current Page Architecture

### Section 1 — Mission (sits on sunset gradient)
- Background: `linear-gradient(160deg, #7B1E00 0%, #C0390A 18%, #E8621A 35%, #F97316 52%, #FBBF24 70%, #FDE68A 88%, #FFF8DC 100%)`
- Font family: `'Montserrat', 'Inter', sans-serif`
- Back nav: white text `#ffffff`
- H1 title: white `#ffffff`, `textShadow: '0 2px 20px rgba(0,0,0,0.3)'`, `clamp(2rem, 6vw, 3.5rem)`
- Underline bar: `rgba(255,255,255,0.5)`, 80px wide, 4px tall
- Lead headline: white `#ffffff`, font-black uppercase, `clamp(1.1rem, 2.5vw, 1.35rem)`
- Body paragraphs: `#f0f4ff` (crisp cool white), fontWeight 500
- Closing line: white `#ffffff`, font-black uppercase, `clamp(1rem, 2.2vw, 1.25rem)`

### Section 2 — Founder (dark navy full-width panel)
- Background: `#0d1b2a`
- Section label: orange line (`#F97316`, 40px × 2px) + "MEET THE FOUNDER" in `#F97316`, tracking-widest
- Layout: `md:grid-cols-5` — photo takes 2 cols, bio takes 3 cols

#### Photo Column (md:col-span-2)
- Image: rounded-xl, `boxShadow: '0 24px 64px rgba(0,0,0,0.5)'`, orange border `rgba(249,115,22,0.25)`
- Name below photo: white `#ffffff`, font-black uppercase, `1.15rem`
- Orange accent line: 32px × 2px, `#F97316`
- Title lines: slate `#94a3b8`, 0.65rem, tracking-widest
- Facebook box: orange-tinted bg `rgba(249,115,22,0.1)`, orange border `rgba(249,115,22,0.2)`

#### Bio Column (md:col-span-3)
- H2: "Built From / **Experience.**" — white + orange span, font-black uppercase, `clamp(1.6rem, 3.5vw, 2.2rem)`
- Body paragraphs: `#94a3b8`, fontWeight 500, 0.95rem, lineHeight 1.8
- Pull quote block: bg `rgba(249,115,22,0.08)`, left border `3px solid #F97316`, quote white `#ffffff` italic font-black 1.1rem, attribution orange `#F97316`
- Credential pills: 5 pills — `10+ Years Plumbing`, `Computer Systems`, `Gracie Jiu-Jitsu Purple Belt`, `Business Owner`, `Platform Developer`. Style: bg `rgba(255,255,255,0.05)`, border `rgba(255,255,255,0.1)`, text `#94a3b8`, border-radius 999px
