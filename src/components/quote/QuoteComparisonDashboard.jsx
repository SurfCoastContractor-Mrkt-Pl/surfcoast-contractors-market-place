...
const STATUS_CONFIG = {
  pending: {
    ...
    icon: Hourglass,
    description: 'Waiting for the contractor to review your request.',
  },
  view_approved: {
    label: 'Preparing Quote',
    color: 'bg-blue-100 text-blue-700 border-blue-200',
    icon: Clock,
    description: 'The contractor has accepted your request and is preparing a quote.',
  },
  view_denied: {
    label: 'Declined',
    color: 'bg-red-100 text-red-700 border-red-200',
    icon: XCircle,
    description: 'The contractor declined to quote this job.',
  },
  quoted: {
    label: 'Quote Received',
    color: 'bg-green-100 text-green-700 border-green-200',
    icon: CheckCircle,
    description: 'You have received a quote from this contractor.',
  },
  accepted: {
    label: 'Accepted',
    color: 'bg-green-100 text-green-700 border-green-200',
