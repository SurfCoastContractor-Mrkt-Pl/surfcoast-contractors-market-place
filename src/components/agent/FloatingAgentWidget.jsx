...
export default function FloatingAgentWidget({ open, onClose }) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 w-80 max-w-[calc(100vw-3rem)] max-h-[calc(100vh-7rem)] flex flex-col bg-white rounded-xl shadow-2xl border border-slate-200">
      {/* Header */}
