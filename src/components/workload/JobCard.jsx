...
import { Clock, MapPin, Phone, Mail, ChevronDown, ChevronUp } from 'lucide-react';

export default function JobCard({ scope, contractor }) {
  ...
  return (
    <div className={`rounded-lg border p-6 transition-all ${statusColors[scope.status]}`}>
      <div className="flex items-start justify-between">
        <div className="flex-1">
          ...
          {/* Status Badge */}
          <div className="mb-4">
            <span className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${statusTextColors[scope.status]}`}>
