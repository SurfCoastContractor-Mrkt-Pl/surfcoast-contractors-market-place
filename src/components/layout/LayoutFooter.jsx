    ...
    <footer className="bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-slate-100 py-10 sm:py-12 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8">
          ...
          <div>
            <h4 className="font-semibold mb-3 text-slate-200 text-sm">For Contractors</h4>
          ...
          <div>
            <h4 className="font-semibold mb-3 text-slate-200 text-sm">For Clients</h4>
            <ul className="space-y-1.5 text-slate-400">
          ...
          <div>
            <h4 className="font-semibold mb-3 text-slate-200 text-sm">Markets & Vendors</h4>
            <ul className="space-y-1.5 text-slate-400">
