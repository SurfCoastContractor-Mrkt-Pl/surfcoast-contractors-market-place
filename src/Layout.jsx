        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-white border-b border-slate-200">
            <div className="px-4 py-4 space-y-2">
              ...
              <Link to="/RetroArcade" onClick={() => { setMobileMenuOpen(false); window.scrollTo(0, 0); }}>
                  <div className="flex items-center gap-3 p-3 rounded-lg font-bold" style={{ color: '#FF1493' }}>
